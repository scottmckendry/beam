...
// templui component aspectratio - version: v0.82.0 installed by templui v0.82.0
...
func AspectRatio(props ...Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/components/aspectratio/aspectratio.templ`, Line: 30, Col: 12}
			}
