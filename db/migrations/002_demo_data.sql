...
INSERT INTO contacts (id, customer_id, name, role, email, phone, avatar, is_primary, notes) VALUES
('d4e5f6g7-dddd-4ddd-8ddd-dddddddddddd', 'c4d4e4b5-4444-4d4d-9d4d-444444444444', 'Bob Brown', 'Operations', 'bob.brown@umbrella.com', '+1-555-4444', 'bob.png', 0, 'Secondary contact');
INSERT INTO contacts (id, customer_id, name, role, email, phone, avatar, is_primary, notes) VALUES
('e5f6g7h8-eeee-4eee-8eee-eeeeeeeeeeee', 'c5e5e5b6-5555-4e5e-9e5e-555555555555', 'Rachel Green', 'CFO', 'rachel.green@wayne.com', '+1-555-5555', 'rachel.png', 1, 'Finance contact');

-- Demo data for activity_log table
INSERT INTO activity_log (id, customer_id, activity_type, action, description) VALUES
('f1a2b3c4-aaaa-4aaa-8aaa-aaaaaaaaaaaa', 'c1a1e1b2-1111-4a1a-9a1a-111111111111', 'login', 'user_login', 'Jane Smith logged in.');
INSERT INTO activity_log (id, customer_id, activity_type, action, description) VALUES
('f2b3c4d5-bbbb-4bbb-8bbb-bbbbbbbbbbbb', 'c2b2e2b3-2222-4b2b-9b2b-222222222222', 'update', 'profile_update', 'John Doe updated company profile.');
INSERT INTO activity_log (id, customer_id, activity_type, action, description) VALUES
('f3c4d5e6-cccc-4ccc-8ccc-cccccccccccc', 'c3c3e3b4-3333-4c3c-9c3c-333333333333', 'support', 'ticket_created', 'Alice Johnson created a support ticket.');
INSERT INTO activity_log (id, customer_id, activity_type, action, description) VALUES
('f4d5e6f7-dddd-4ddd-8ddd-dddddddddddd', 'c4d4e4b5-4444-4d4d-9d4d-444444444444', 'billing', 'invoice_paid', 'Bob Brown paid invoice #1234.');
INSERT INTO activity_log (id, customer_id, activity_type, action, description) VALUES
('f5e6f7g8-eeee-4eee-8eee-eeeeeeeeeeee', 'c5e5e5b6-5555-4e5e-9e5e-555555555555', 'login', 'user_login', 'Rachel Green logged in.');
